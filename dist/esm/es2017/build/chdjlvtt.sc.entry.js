...
function getStartWeek(by) {
    return hooks(by).startOf('isoWeek').toDate();
}
function getEndWeek(by) {
    return hooks(by).endOf('isoWeek').toDate();
}
function eventsFromRange(from, to, events) {
    return (events || []).filter(event => {
        return event.from >= from && event.to <= to;
    });
}
function eventsFromDate(date, events) {
    return events.filter(event => {
...
class Week {
    constructor(date) {
        ...
        this.days.forEach((day, ind) => {
            day.date = hooks(this[FROM]).add(ind, 'd').toDate();
        });
    }
    set events(events) {
...
class ScheduleContainer {
    ...
    static get style() { return ".sc-schedule-container-h{display:inline-block}schedule-header.sc-schedule-container{font-family:Arial;font-size:14px;color:hsla(0,0%,47.1%,.8)}"; }
}
...
class ScheduleDayComponent {
    ...
    static get style() { return ".sc-schedule-day-h{-webkit-box-sizing:border-box;box-sizing:border-box;--timeline-width:45px;--schedule-border-color:hsla(0,0%,47.1%,0.2)}.container.sc-schedule-day{height:100%}.container.sc-schedule-day, .root.sc-schedule-day{display:-ms-flexbox;display:flex}.root.sc-schedule-day{-ms-flex-direction:column;flex-direction:column}.resource-header-cont.sc-schedule-day{margin-left:42px;display:-ms-flexbox;display:flex}.header.sc-schedule-day{text-align:center}.header.sc-schedule-day:not(:last-child){border-right:1px solid var(--schedule-border-color,hsla(0,0%,47.1%,.7))}schedule-timeline.sc-schedule-day{border-top:1px solid var(--schedule-border-color,hsla(0,0%,47.1%,.7))}.sc-schedule-day-h{display:block;border:1px solid var(--schedule-border-color,hsla(0,0%,47.1%,.7));padding-left:var(--timeline-width)}schedule-day-board.sc-schedule-day{border-top:1px solid var(--schedule-border-color,hsla(0,0%,47.1%,.7));margin-left:calc(var(--timeline-width) * -1);height:100%;width:calc(100% + var(--timeline-width));-webkit-box-sizing:border-box;box-sizing:border-box}.sc-schedule-day-s > schedule-header:not(:last-of-type), .sc-schedule-day-s > schedule-resource:not(:last-of-type){border-right:1px solid var(--schedule-border-color,hsla(0,0%,47.1%,.7))}.sc-schedule-day-s > schedule-header:first-of-type, .sc-schedule-day-s > schedule-resource:first-of-type{border-left:1px solid var(--schedule-border-color,hsla(0,0%,47.1%,.7))}.sc-schedule-day-s > schedule-header{display:inline-block;-webkit-box-sizing:border-box;box-sizing:border-box}"; }
}
...
class ScheduleDayBoardComponent {
    ...
    static get style() { return ".container.sc-schedule-day-board{width:100%;height:100%}.sc-schedule-day-board-h{display:inline-block}.slot.sc-schedule-day-board:not(:last-of-type)   .board-slot.sc-schedule-day-board{border-bottom:1px solid var(--schedule-border-color,hsla(0,0%,47.1%,.7));-webkit-box-sizing:border-box;box-sizing:border-box}.slot.sc-schedule-day-board{position:relative}.time-slot.sc-schedule-day-board{height:100%;display:inline-block;width:var(--timeline-width);text-align:center;top:-9px;position:absolute;color:hsla(0,0%,47.1%,.8);font-family:Arial;font-size:14px}.board-slot.sc-schedule-day-board{float:right;height:100%;width:calc(100% - var(--timeline-width))}"; }
}
...
class ScheduleDayEventComponent {
    ...
    static get style() { return ".root.sc-schedule-day-event, .sc-schedule-day-event-s > *{height:100%}"; }
}
...
class ScheduleResourceComponent {
    ...
    static get style() { return ".sc-schedule-resource-h{height:100%;position:absolute;-webkit-box-sizing:border-box;box-sizing:border-box}.sc-schedule-resource-s > schedule-day-event{width:calc(100% - 20px);margin-left:10px}.header.sc-schedule-resource{width:100%;position:absolute;top:calc(var(--header-height) * -1);border-right:1px solid var(--schedule-border-color,hsla(0,0%,47.1%,.7));height:var(--header-height)}"; }
}

export { ScheduleContainer, ScheduleDayComponent as ScheduleDay, ScheduleDayBoardComponent as ScheduleDayBoard, ScheduleDayEventComponent as ScheduleDayEvent, ScheduleResourceComponent as ScheduleResource };
