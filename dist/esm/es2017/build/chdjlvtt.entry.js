...
class ScheduleContainer {
    ...
    static get style() { return ":host{display:inline-block}schedule-header{font-family:Arial;font-size:14px;color:hsla(0,0%,47.1%,.8)}"; }
}
...
class ScheduleDayEventComponent {
    ...
    static get style() { return ".root,::slotted(*){height:100%}"; }
}
...
class ScheduleResourceComponent {
    ...
    static get style() { return ":host{height:100%;position:absolute;-webkit-box-sizing:border-box;box-sizing:border-box}::slotted(schedule-day-event){width:calc(100% - 20px);margin-left:10px}.header{width:100%;position:absolute;top:calc(var(--header-height) * -1);border-right:1px solid var(--schedule-border-color,hsla(0,0%,47.1%,.7));height:var(--header-height)}"; }
}
